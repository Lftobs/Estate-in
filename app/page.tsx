...
export default function Home() {
  return (
    <section className="flex items-center bg-black-btn w-full pl-28 max-w-[1600px] max-lg:flex-col-reverse max-lg:pl-0">
      <div className="w-1/2 flex flex-col max-lg:w-11/12">
        <h1 className="max-w-[26rem] text-balance font-bold text-[2.5rem] text-3xl">Discover Your Dream Property with Estatein</h1>
        <p className="max-w-[80%] mt-4 opacity-70 text-sm w-[70%]">Your journey to finding the perfect property begins here. Explore our listings to find the home that matches your dreams.</p>
